...
exports.aktifGorevleriGetir = aktifGorevleriGetir;
 ...
 */
async function aktifGorevleriGetir(req, res) {
    try {
        ...
        if (kullaniciRol === "TEKNISYEN" || kullaniciRol === "YONETICI") {
            ...
            const bakimGorevleri = await prisma_1.default.bakim_kaydi.findMany({
                where: {
                    bakim_tarihi: {
                        gte: otuzGunOnce
                    }
        ...
        if (kullaniciRol === "OPERATOR") {
            ...
            const kontroller = await prisma_1.default.gunluk_kontrol_formu.findMany({
                where: {
