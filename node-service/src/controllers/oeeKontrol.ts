...
import { fabrikaOeeHesapla, makineOeeHesapla } from '../services/oeeService';

function tarihAraligiOku(req: Request) {
...
export async function getMakineOee(makineId: number, baslangicTarihi: Date, bitisTarihi: Date) {
    return makineOeeHesapla(makineId, baslangicTarihi, bitisTarihi);
}
...
export async function oeeGetir(req: Request, res: Response) {
    try {
        ...
        const sonuc = await makineOeeHesapla(makineId, baslangicTarihi, bitisTarihi);
...
export async function topluOeeGetir(req: Request, res: Response) {
    try {
        ...
        const sonuc = await fabrikaOeeHesapla(baslangicTarihi, bitisTarihi);
