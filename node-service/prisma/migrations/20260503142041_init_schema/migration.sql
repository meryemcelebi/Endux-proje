...
CREATE TABLE "bakim_kaydi" (
    ...
    "durum" VARCHAR(50) DEFAULT 'BEKLEYEN',
...
-- CreateTable
CREATE TABLE "durus_kaydi" (
    "durus_id" SERIAL NOT NULL,
    "makine_id" INTEGER NOT NULL,
    "vardiya_tarihi" DATE NOT NULL,
    "baslangic_saati" TIMESTAMPTZ(6) NOT NULL,
    "bitis_saati" TIMESTAMPTZ(6),
    "durus_sure_dk" INTEGER,
    "durus_nedeni" VARCHAR(255) NOT NULL,
    "olusturma_tarihi" TIMESTAMPTZ(6) DEFAULT CURRENT_TIMESTAMP,
    "kullanici_id" INTEGER,

    CONSTRAINT "durus_kaydi_pkey" PRIMARY KEY ("durus_id")
);
...
CREATE TABLE "oee_raporlari" (
    ...
    CONSTRAINT "oee_raporlari_pkey" PRIMARY KEY ("rapor_id")
);
...
-- CreateTable
CREATE TABLE "uretim_kaydi" (
    "uretim_id" SERIAL NOT NULL,
    "makine_id" INTEGER NOT NULL,
    "vardiya_tarihi" DATE NOT NULL,
    ...
    CONSTRAINT "uretim_kaydi_pkey" PRIMARY KEY ("uretim_id")
);
...
-- CreateIndex
CREATE INDEX "idx_durus_makine" ON "durus_kaydi"("makine_id");

-- CreateIndex
CREATE INDEX "idx_durus_makine_tarih" ON "durus_kaydi"("makine_id", "vardiya_tarihi");

-- CreateIndex
CREATE INDEX "idx_durus_tarih" ON "durus_kaydi"("vardiya_tarihi");
...
-- CreateIndex
CREATE UNIQUE INDEX "kullanici_adi" ON "kullanici"("kullanici_adi");
...
-- CreateIndex
CREATE UNIQUE INDEX "oee_raporlari_makine_id_tarih_key" ON "oee_raporlari"("makine_id", "tarih");
...
-- CreateIndex
CREATE UNIQUE INDEX "servis_puan_bakim_id_key" ON "servis_puan"("bakim_id");
...
-- CreateIndex
CREATE INDEX "idx_uretim_makine" ON "uretim_kaydi"("makine_id");

-- CreateIndex
CREATE INDEX "idx_uretim_makine_tarih" ON "uretim_kaydi"("makine_id", "vardiya_tarihi");

-- CreateIndex
CREATE INDEX "idx_uretim_tarih" ON "uretim_kaydi"("vardiya_tarihi");
...
-- AddForeignKey
ALTER TABLE "bakim_kaydi" ADD CONSTRAINT "fk_kullanici" FOREIGN KEY ("kullanici_id") REFERENCES "kullanici"("kullanici_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "bakim_kaydi" ADD CONSTRAINT "fk_servis_sorumlu" FOREIGN KEY ("sorumlu_id") REFERENCES "servis_sorumlusu"("sorumlu_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "durus_kaydi" ADD CONSTRAINT "fk_durus_kullanici" FOREIGN KEY ("kullanici_id") REFERENCES "kullanici"("kullanici_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "durus_kaydi" ADD CONSTRAINT "fk_durus_makine" FOREIGN KEY ("makine_id") REFERENCES "makine"("makine_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "oee_raporlari" ADD CONSTRAINT "oee_raporlari_makine_id_fkey" FOREIGN KEY ("makine_id") REFERENCES "makine"("makine_id") ON DELETE CASCADE ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "parca_degisim" ADD CONSTRAINT "parca_degisim_bakim_id_fkey" FOREIGN KEY ("bakim_id") REFERENCES "bakim_kaydi"("bakim_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "parca_degisim" ADD CONSTRAINT "parca_degisim_bakim_kaydi_id_fkey" FOREIGN KEY ("bakim_kaydi_id") REFERENCES "bakim_kaydi"("bakim_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "servis_puan" ADD CONSTRAINT "servis_puan_bakim_id_fkey" FOREIGN KEY ("bakim_id") REFERENCES "bakim_kaydi"("bakim_id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "uretim_kaydi" ADD CONSTRAINT "fk_uretim_kullanici" FOREIGN KEY ("kullanici_id") REFERENCES "kullanici"("kullanici_id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "uretim_kaydi" ADD CONSTRAINT "fk_uretim_makine" FOREIGN KEY ("makine_id") REFERENCES "makine"("makine_id") ON DELETE NO ACTION ON UPDATE NO ACTION;
